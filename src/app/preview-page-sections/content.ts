...
export const templateDetails = {
  name: 'FITMEX STORE',
  description: 'Llévate todo lo que necesitas para potenciar tu entrenamiento.',
  screenshotsOne: [preview, collection, singleProduct, preview],
  screenshotsTwo: [preview, singleProduct, collection, preview],
};
